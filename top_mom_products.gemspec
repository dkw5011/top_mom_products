...
Gem::Specification.new do |spec|
  spec.name          = "top_mom_products"
  spec.version       = TopMomProducts::VERSION
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "http://www.myurl.com"
    spec.metadata["changelog_uri"] = "http://www.myurl.com"
  else
